...
/***/ "./app/assets/images/icons/info-circle.svg":
/*!*************************************************!*\
  !*** ./app/assets/images/icons/info-circle.svg ***!
  \*************************************************/
...
const ForwardRef = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(SvgInfoCircle);
...
/* harmony import */ var _Components_ExpiredPaymentStandardAlert__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/ExpiredPaymentStandardAlert */ "./app/javascript/src/Components/ExpiredPaymentStandardAlert.tsx");
/* harmony import */ var _Components_CurrencyTextInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/CurrencyTextInput */ "./app/javascript/src/Components/CurrencyTextInput.tsx");
/* harmony import */ var react_hook_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-hook-form */ "../node_modules/react-hook-form/dist/index.esm.mjs");
/* harmony import */ var _Components_SelectInput__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/SelectInput */ "./app/javascript/src/Components/SelectInput.tsx");
/* harmony import */ var _Components_RadioSelectInput__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Components/RadioSelectInput */ "./app/javascript/src/Components/RadioSelectInput.tsx");
/* harmony import */ var _Components_Button__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Components/Button */ "./app/javascript/src/Components/Button.tsx");
/* harmony import */ var _Components_Switch__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Components/Switch */ "./app/javascript/src/Components/Switch.tsx");
/* harmony import */ var _Hooks_useJsonData__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Hooks/useJsonData */ "./app/javascript/src/Hooks/useJsonData.ts");
/* harmony import */ var _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Hooks/AffordabilityCalculator/consts */ "./app/javascript/src/Hooks/AffordabilityCalculator/consts.ts");
/* harmony import */ var _Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Hooks/AffordabilityCalculator/utils */ "./app/javascript/src/Hooks/AffordabilityCalculator/utils.ts");
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
...
var AffordabilityCalculatorComponent = function AffordabilityCalculatorComponent() {
  var _useJsonData = (0,_Hooks_useJsonData__WEBPACK_IMPORTED_MODULE_10__["default"])(_Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PAYMENT_STANDARD_URL),
  ...
  var _useForm = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_5__.useForm)({
      defaultValues: _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.FORM_DEFAULT
    }),
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(_Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.RESULT),
  ...
  var onSubmit = function onSubmit(data) {
    ...
    if (activePaymentStandard) {
      setResult((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getResultForInput)(data, activePaymentStandard));
    } else {
  ...
  var getActivePaymentStandard = function getActivePaymentStandard() {
    var _paymentStandardData, _paymentStandardData2, _paymentStandardData3, _paymentStandardData4;
    ...
    if (watch('useUpcomingPaymentStandard') && ((_paymentStandardData3 = paymentStandardData) === null || _paymentStandardData3 === void 0 ? void 0 : _paymentStandardData3.upcomingStartDate) !== undefined && ((_paymentStandardData4 = paymentStandardData) === null || _paymentStandardData4 === void 0 ? void 0 : _paymentStandardData4.expiredEndDate) === undefined) {
      var _paymentStandardData5;
      return (_paymentStandardData5 = paymentStandardData) === null || _paymentStandardData5 === void 0 ? void 0 : _paymentStandardData5.upcoming;
    } else {
      var _paymentStandardData6;
      return (_paymentStandardData6 = paymentStandardData) === null || _paymentStandardData6 === void 0 ? void 0 : _paymentStandardData6.current;
    }
  };
  var setPaymentStandardData = function setPaymentStandardData(program) {
    var paymentStandardData = (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getPaymentStandardData)(jsonData || {}, program);
  ...
  var setExploreMode = function setExploreMode() {
    ...
    var utilities = _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[watch('voucherType')]['utilities'];
  ...
  var onReset = function onReset() {
    reset();
    setResult(_Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.RESULT);
  };
  ...
  var barHtml = function barHtml() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    }, "Gross Rent: ", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.rentPlusUtilities)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "ms-2"
    }, "Tenant Share: ", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estTenantShare))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "ms-2"
    }, "Voucher Payment: ", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.subsidy)))));
  };
  var submitElementHtml = function submitElementHtml() {
    ...
    var expiredEndDate = (_watch2 = watch('paymentStandardData')) === null || _watch2 === void 0 ? void 0 : _watch2.expiredEndDate;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "row mt-3"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "col-lg-12 col-12 g-0"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_ExpiredPaymentStandardAlert__WEBPACK_IMPORTED_MODULE_3__["default"], {
      show: expiredEndDate !== undefined,
      ...
      show: upcomingStartDate !== undefined && expiredEndDate === undefined,
    ...
    }, error, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
  ...
  var fullFormElementsHtml = function fullFormElementsHtml() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
      ...
      className: "col-lg-4 col-12"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_SelectInput__WEBPACK_IMPORTED_MODULE_6__["default"], _extends({
      label: "Bedrooms"
    }, register("unitSize", {
      required: 'Must be provided'
    }), {
      ...
      options: (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.bedroomOptions)()
    }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "col-lg-4 col-12"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_CurrencyTextInput__WEBPACK_IMPORTED_MODULE_4__["default"], _extends({
      label: "Monthly rent"
  ...
  var formHtml = function formHtml() {
    if (!result.type) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        ...
        options: (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeOptions)()
      }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        className: "col-lg-4 col-6"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_SelectInput__WEBPACK_IMPORTED_MODULE_6__["default"], _extends({
        label: "Voucher Size"
      ...
      }, "Are you looking at a specific apartment or just exploring a general area?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_RadioSelectInput__WEBPACK_IMPORTED_MODULE_7__["default"], _extends({
        id: "mode"
      }, register('mode', {
        required: 'Must be provided'
      }), {
  ...
  var utilitiesHtml = function utilitiesHtml() {
    ...
    var utilities = _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[voucherType]['utilities'];
    var utilityKeys = Object.keys(utilities);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_RadioSelectInput__WEBPACK_IMPORTED_MODULE_7__["default"], _extends({
  ...
  var exploreTenantShareTableHtml = function exploreTenantShareTableHtml() {
    ...
    if (result.affordable == 'minimumContributionExpected' && _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[result.voucherType].minimumContribution > 0) {
      message = "Your share of housing costs, as the tenant, the greater of 30% of your monthly adjusted gross income, or ".concat(result.estTenantShare, ", the minimum payment for ").concat((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType), " vouchers.");
    }
    ...
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estTenantShare))))));
    if (watch('useMaxIncomePercent')) {
      ...
      }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(Math.round(0.3 * result.monthlyIncome)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      ...
      }, "+", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(Math.round(0.1 * result.monthlyIncome)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
        className: "fw-bold"
      }, "Tenant Share"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
        className: "fw-bold w-25 text-end",
        id: "outputTenantShare"
  ...
  var exploreMaxRentHtml = function exploreMaxRentHtml() {
    var explainer = ["The voucher pays for the difference between", result.affordable == 'minimumContributionExpected' ? "the minimum tenant payment," : "30% of your income,", "and the gross rent up to the payment standard.", "The payment standard is calculated based on the voucher size of ".concat(_Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.SIZES[result.unitSize].weight), "and a zip code of ".concat(result.zipCode, " (").concat((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.paymentStandard), ").")].join(' ');
    ...
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.landlordPaysUtilitiesMaxRent))))));
    if (watch('useMaxIncomePercent')) {
      exploreVoucherTable = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("table", {
        ...
        className: "w-25 text-end"
      }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.landlordPaysUtilitiesMaxRent - Math.round(0.1 * result.monthlyIncome)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
        className: "border-bottom border-dark"
      }, "Additional 10% of monthly income"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
        className: "border-bottom border-dark w-25 text-end"
      }, "+", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(Math.round(0.1 * result.monthlyIncome)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      ...
      className: "w-25 text-end"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.landlordPaysUtilitiesMaxRent))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark"
    }, "Maximum estimated utilities"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark w-25 text-end",
      id: "outputUtilities"
    }, "-", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estimatedHighestUtilityDeduction))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold"
    ...
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.tenantPaysUtilitiesMaxRent))))));
  };
  ...
  var grossRentHtml = function grossRentHtml() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      ...
      className: "w-25 text-end",
      id: "outputRent"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.rent))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark"
    }, "Estimated utilities"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark w-25 text-end",
      id: "outputUtilities"
    }, "+", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.utilities))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold"
    }, "Gross rent"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold w-25 text-end",
      id: "outputGrossRent"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.rentPlusUtilities))))));
  };
  var voucherPaymentHtml = function voucherPaymentHtml() {
    ...
    var secondRowValue = Math.max(result.monthlyIncome * 0.3, _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[result.voucherType].minimumContribution);
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      ...
      className: "w-25 text-end",
      id: "outputFirstRow"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(firstRowValue))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark"
      ...
      id: "outputSecondRow"
    }, "-", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(secondRowValue))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold"
    }, "Voucher Payment"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold text-end",
      id: "outputVoucherPayment"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.subsidy))))));
  };
  ...
  var tenantShareTableHtml = function tenantShareTableHtml() {
    ...
    var message = ["Your share of housing costs will be ", result.affordable == 'minimumContributionExpected' ? "".concat((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estTenantShare), ", the minimum payment for a ").concat((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType), " voucher") : '30% of your monthly adjusted gross income', result.rentPlusUtilities > result.paymentStandard ? ', plus any housing cost that exceeds the payment standard.' : '.'].join('');
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      ...
      className: "w-25 text-end"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.rentPlusUtilities))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark"
    }, "Voucher Payment"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "border-bottom border-dark w-25 text-end"
    }, "-", (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.subsidy), " ")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold"
    }, "Tenant Share"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", {
      className: "fw-bold w-25 text-end",
      id: "outputTenantShare"
    }, (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estTenantShare))))), percentMessage);
  };
  var resultHeader = function resultHeader(title) {
    var limit = (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getLimitFor)(result);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  var estimatedShareHtml = function estimatedShareHtml() {
    var limit = (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getLimitFor)(result);
    var minimum = _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[result.voucherType].minimumContribution;
    if (limit.estimatedRentMessage && (result.affordable === 'affordableWithoutVoucher' || result.affordable === 'affordableWithVoucher' || result.affordable === 'maybeAffordableWithVoucher' || result.affordable == "minimumContributionExpected")) {
      var message = limit.estimatedRentMessage.replace('{tenantShare}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.estTenantShare)).replace('{minRent}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(minimum)).replace('{voucherType}', String((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType)));
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  var buttonsHtml = function buttonsHtml() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "col-lg-4 col-12"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
      type: "reset",
      color: "primary",
      className: "ms-0 me-0 pl-0 pr-0 mb-3 w-100",
      onClick: onBack
  ...
  var fullResultHtml = function fullResultHtml() {
    var limit = (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getLimitFor)(result);
    var title = limit.title.replace('{rent}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.rent)).replace('{zipCode}', String(result.zipCode)).replace('{voucherType}', String((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType))).replace('{bedroomSize}', _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.SIZES[result.unitSize].label.toLowerCase().replace(' ', '-'));
    var minimum = _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[result.voucherType].minimumContribution;
    var affordableMessage = limit.affordableMessage.replace('{minRent}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(minimum)).replace('{voucherType}', String((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType)));
  ...
  var willingToPayToggle = function willingToPayToggle() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Components_Switch__WEBPACK_IMPORTED_MODULE_9__["default"], _extends({
      className: "mt-3",
  ...
  var exploreResultHtml = function exploreResultHtml() {
    var limit = (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.getLimitFor)(result);
    var title = limit.title.replace('{maxRentFrom}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.tenantPaysUtilitiesMaxRent)).replace('{maxRentTo}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.landlordPaysUtilitiesMaxRent)).replace('{rent}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(result.tenantPaysUtilitiesMaxRent)).replace('{bedroomSize}', _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.SIZES[result.unitSize].label.toLowerCase().replace(' ', '-')).replace('{zipCode}', String(result.zipCode)).replace('{voucherType}', String((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType)));
    var minimum = _Hooks_AffordabilityCalculator_consts__WEBPACK_IMPORTED_MODULE_11__.PROGRAMS[result.voucherType].minimumContribution;
    var affordableMessage = limit.affordableMessage.replace('{minRent}', (0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.currencyFormat)(minimum)).replace('{voucherType}', String((0,_Hooks_AffordabilityCalculator_utils__WEBPACK_IMPORTED_MODULE_12__.voucherTypeLabel)(result.voucherType)));
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, resultHeader(title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "container"
...
/***/ "./app/javascript/src/Components/AppIcon.tsx":
/*!***************************************************!*\
  !*** ./app/javascript/src/Components/AppIcon.tsx ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AppIcon: function() { return /* binding */ AppIcon; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _assets_images_icons_info_circle_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../assets/images/icons/info-circle.svg */ "./app/assets/images/icons/info-circle.svg");
var _excluded = ["name", "height", "width", "className", "title"];
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
function _objectWithoutProperties(e, t) { if (null == e) return {}; var o, r, i = _objectWithoutPropertiesLoose(e, t); if (Object.getOwnPropertySymbols) { var n = Object.getOwnPropertySymbols(e); for (r = 0; r < n.length; r++) o = n[r], -1 === t.indexOf(o) && {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]); } return i; }
function _objectWithoutPropertiesLoose(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (-1 !== e.indexOf(n)) continue; t[n] = r[n]; } return t; }
...
/**
 * React mirror of the Rails-side `app_icon` view helper.
 *
 * Both helpers resolve `name` against the shared SVG set in
 * `app/assets/images/icons/` and inline the markup, so call sites read the same
 * way on either side:
 *
 *   Rails:  app_icon('info-circle', height: 20, width: 20)
 *   React:  <AppIcon name="info-circle" height={20} width={20} />
 *
 * To make a new icon available, add an entry to ICONS below. Names are
 * type-checked, so typos surface at compile time. Only icons listed here are
 * bundled.
 */
var ICONS = {
  'info-circle': _assets_images_icons_info_circle_svg__WEBPACK_IMPORTED_MODULE_1__["default"]
};
var AppIcon = function AppIcon(_ref) {
  ...
  var Svg = ICONS[name];
  var composedClassName = ['bi', "bi-".concat(name), className].filter(Boolean).join(' ');
  var a11yProps = title ? {
    role: 'img',
    'aria-label': title
  } : {
...
/***/ "./app/javascript/src/Components/ExpiredPaymentStandardAlert.tsx":
/*!***********************************************************************!*\
  !*** ./app/javascript/src/Components/ExpiredPaymentStandardAlert.tsx ***!
  \***********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ExpiredPaymentStandardAlert: function() { return /* binding */ ExpiredPaymentStandardAlert; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "../node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Alert */ "./app/javascript/src/Components/Alert.tsx");
/* harmony import */ var _AppIcon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppIcon */ "./app/javascript/src/Components/AppIcon.tsx");



var ExpiredPaymentStandardAlert = function ExpiredPaymentStandardAlert(_ref) {
  var _ref$show = _ref.show,
    show = _ref$show === void 0 ? false : _ref$show,
    expiredEndDate = _ref.expiredEndDate,
    _ref$dismissible = _ref.dismissible,
    dismissible = _ref$dismissible === void 0 ? false : _ref$dismissible,
    onClose = _ref.onClose,
    _ref$className = _ref.className,
  ...
  var defaultContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "px-3"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AppIcon__WEBPACK_IMPORTED_MODULE_2__.AppIcon, {
    name: "info-circle",
    height: 20,
    width: 20
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "ms-2"
  }, "Payment Standards Expired")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "mt-2 mb-0"
  }, "Note: Payment standards expire on ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    id: "expired-ps-alert-date"
  }, expiredEndDate), "; until updated standards are applied, this calculator will use the most recently available payment standards."));
...
/* harmony default export */ __webpack_exports__["default"] = (ExpiredPaymentStandardAlert);
...
/* harmony import */ var _Alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Alert */ "./app/javascript/src/Components/Alert.tsx");
/* harmony import */ var _AppIcon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppIcon */ "./app/javascript/src/Components/AppIcon.tsx");
/* harmony import */ var _Switch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Switch */ "./app/javascript/src/Components/Switch.tsx");
...
var UpcomingPaymentStandardAlert = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(function (_ref, ref) {
  ...
  }, upcomingStartDate), ", which may affect what you can afford. Contact the agency that issued your voucher to determine which payment standards should be used to calculate affordability."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Switch__WEBPACK_IMPORTED_MODULE_3__["default"], {
    className: "mt-3",
...
var getPaymentStandardData = function getPaymentStandardData(jsonData, program) {
  ...
  if (currentPsDateIndex === undefined) {
    var expiredPsDateRanges = psDateRanges.filter(function (dateRange) {
      return Date.parse(dateRange[1]) < parsedToday.getTime();
    });
    if (expiredPsDateRanges.length) {
      var _expiredPsDateRanges = _slicedToArray(expiredPsDateRanges[expiredPsDateRanges.length - 1], 2),
        _dateFromKey = _expiredPsDateRanges[0],
        _dateToKey = _expiredPsDateRanges[1];
      paymentStandardData.current = ps[_dateFromKey][_dateToKey];
      paymentStandardData.expiredEndDate = new Intl.DateTimeFormat('en-US', {
        month: 'short',
        day: 'numeric',
        year: 'numeric',
        timeZone: 'UTC'
      }).format(new Date(_dateToKey));
    }
    return paymentStandardData;
  }
  ...
  if (upcomingPsDateIndex < psDateRanges.length) {
    var _psDateRanges$upcomin = _slicedToArray(psDateRanges[upcomingPsDateIndex], 2),
      _dateFromKey2 = _psDateRanges$upcomin[0],
      _dateToKey2 = _psDateRanges$upcomin[1];
    if (isWithinSixtyDays(_dateFromKey2)) {
      paymentStandardData.upcomingStartDate = new Intl.DateTimeFormat('en-US', {
        month: 'short',
        day: 'numeric',
        year: 'numeric',
        timeZone: 'UTC'
      }).format(new Date(_dateFromKey2));
      paymentStandardData.upcoming = ps[_dateFromKey2][_dateToKey2];
    }
  }
  return paymentStandardData;
};
...
//# sourceMappingURL=affordability_calculator-772ffdc1bb6c00bc1db5.js.map